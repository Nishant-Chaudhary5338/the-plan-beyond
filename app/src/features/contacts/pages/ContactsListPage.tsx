...
export default function ContactsListPage() {
  ...
  return (
    <div className="mx-auto flex max-w-7xl flex-col py-8 lg:h-full">
      <PeopleHeader
      ...
      <div className="mt-8 grid gap-5 lg:min-h-0 lg:flex-1 lg:grid-cols-[340px_1fr] lg:grid-rows-[minmax(0,1fr)]">
        <PeopleSidebar />
