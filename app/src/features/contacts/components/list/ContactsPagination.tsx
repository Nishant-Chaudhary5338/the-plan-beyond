...
interface ContactsPaginationProps {
  ...
  pageSize: number;
  total: number;
  /** Total page count, computed once in `useContactsQuery` and passed down. */
  pageCount: number;
  onPageChange: (page: number) => void;
}

/** "1–25 of 132" range label with prev/next controls. */
export function ContactsPagination({ page, pageSize, total, pageCount, onPageChange }: ContactsPaginationProps) {
